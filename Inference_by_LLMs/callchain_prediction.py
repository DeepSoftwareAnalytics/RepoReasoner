...
def main():
    ...
    parser.add_argument("--api_base_url", type=str, required=True, help="Base URL of the OpenAI-compatible API.")
    ...
    parser.add_argument("--ratios", nargs='+', type=float, default=[0.25, 0.5], help="Token budget ratios for call chain files.")
