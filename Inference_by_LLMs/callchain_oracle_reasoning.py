    ...
    for ratio in Config.CALL_CHAIN_RATIOS:
        ...
        with open(predictions_output_file, 'w', encoding='utf-8') as pred_f, \
            ...
            for task_item in task_iterator:
                ...
                response_text, reasoning_content, finish_reason, usage, error_details = "ERROR: INIT", None, "error", None, None
                
                try:
                    is_reasoning_model = "o1-" in Config.MODEL_NAME or "reasoner" in Config.MODEL_NAME.lower()
                ...
                interaction_record = {
                    ...
                    "sample_id": task_item['sample_idx'], 
                    "ratio": ratio, 
                    "messages": messages, 
                    "files_in_prompt": included_pos, 
                    "ground_truth_chain": task_item['positive_pool'], 
                    "error": error_details,
                    "model_response_reasoning": reasoning_content 
                }
                intr_f.write(json.dumps(interaction_record, ensure_ascii=False) + "\n")
...
# ==============================================================================
def main():
    parser = argparse.ArgumentParser(description="Run call chain prediction experiment (API version - Reasoning Aware).")
    ...
    parser.add_argument("--model_name", type=str, default='deepseek-v3.1', help="Model name.") 
    # deepseek-v3.1 DeepSeek-R1-Distill-Qwen-14B 
    parser.add_argument("--context_window", type=int, default=20480, help="Context window.")
    parser.add_argument("--ratios", nargs='+', type=float, default=[1.0], help="Ratios.")
